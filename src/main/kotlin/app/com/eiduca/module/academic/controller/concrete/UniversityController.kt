...
class UniversityController(
    ...
    override fun save(@Valid @RequestBody request: UniversityRequest) = super.save(request)
    ...
    override fun update(@Valid @RequestBody request: UniversityRequest, @PathVariable id: String) = super.update(request, id)
